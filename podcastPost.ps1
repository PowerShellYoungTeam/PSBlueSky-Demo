...
$postText = "Shout out to The Big Plabowski for having me on the PowerShell Podcast! was an absolute blast! you can grab it here: How PowerShell and the Right Mindset Can Transform Your IT Career The PS Podcast E161 Steven Wight"
...
# Mentions
$usernameText = "The Big Plabowski"
# The DID of the mention
$mentionDid = "did:plc:xrspiwserax6shgskcj7grgg"
...
# Tags
$PostTagText = "PowerShell Podcast"
